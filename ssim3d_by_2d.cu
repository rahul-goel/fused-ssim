...
// ------------------------------------------
__global__ void fusedssim3d_by_2dCUDA(
    int H, //height
    int W, //width
    int D, //depth
    int B, //batch size
...
__global__ void fusedssim_backward3d_by_2dCUDA(
    int H,
    int W,
    int D,
    int B,
...
fusedssim3d_by_2d(
    ...
    fusedssim3d_by_2dCUDA<<<grid, block>>>(
        H, W, D, B, CH, C1, C2,
...
fusedssim_backward3d_by_2d(
    ...
    fusedssim_backward3d_by_2dCUDA<<<grid, block>>>(
        H, W, D, B, CH, C1, C2,
        img1.contiguous().data_ptr<float>(),
        img2.contiguous().data_ptr<float>(),
